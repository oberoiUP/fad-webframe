...
class UsersTests(unittest.TestCase):
    ...
    def test_invalid_email_registration(self):
        ...
        self.assertNotEqual('email address has to be greater than 0', 0)
        self.assertEqual(response.status_code, 200)
        
    def test_invalid_password_count(self):
      response = self.register('test3', 'test@example', 'FlaskIsAwesome')
      self.assertNotEqual('passord must be greater than 0.', 0)
